...
def main_page():
    ...
    if df_matches.empty:
        ...
        match_selected = st.dataframe(
            df_matches[['League','Rodada','Time','Home','Away','Odd_H_FT','Odd_D_FT','Odd_A_FT','Odd_Over25_FT','Odd_Under25_FT','Odd_BTTS_Yes','Odd_BTTS_No','Odd_DC_1X','Odd_DC_12','Odd_DC_X2']].sort_values(by=["Time", "League"])
            , on_select="rerun"
