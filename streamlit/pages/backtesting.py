...
def main_page(fonte_dados):
    ...
    if filtro_pronto_selecionado != "Sem filtro" or executar:
        ...
        if total_jogos > 0:
            ...
            st.write(f"Jogos: {total_jogos}, Greens: {total_greens}, Reds: {total_reds}, {'Voids: ' + str(total_voids) if total_voids > 0 else ''}, Winrate: {winrate}%, Profit Acumulado Líquido: {profit_acumulado}, Comissão: 2.8%, Odd Média: {odd_media}")
