...
with col1:
    ...
    st.metric(label="MO Home", value=df_match_selected["Odd_H_FT"])
    st.metric(label="MO Draw", value=df_match_selected["Odd_D_FT"])
    st.metric(label="MO Away", value=df_match_selected["Odd_A_FT"])
    st.metric(label="Over 0.5 HT", value=df_match_selected["Odd_Over05_HT"])
    st.metric(label="Over 2.5 FT", value=df_match_selected["Odd_Over25_FT"])
    st.metric(label="BTTS", value=df_match_selected["Odd_BTTS_Yes"])
with col2:
