...
def get_filter_betfair_lay_visitante(df):
    return ( 
        ...
        & (
            ...
            ((df['League'] == 'AUSTRALIA - A-LEAGUE') & (df['FX_Probabilidade_A'] == '0.21-0.30') & (df['FX_CV_HDA'] == '0.35-0.40')) |
            ...
            ((df['League'] == 'COPA LIBERTADORES') & (df['FX_Probabilidade_A'] == '0.12-0.21') & (df['FX_CV_HDA'] == '0.30-0.35')) |
