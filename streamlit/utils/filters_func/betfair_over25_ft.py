...
def get_filter_betfair_over25_ft(df):
    ...
    return (
        ...
        & (
            ...
            ((df['League'] == 'SAUDI ARABIA - SAUDI PROFESSION') & (df['FX_Probabilidade_A'] == '0.30-0.39') & (df['FX_CV_HDA'] == '0.05-0.10')) & ((df['Home'].isin(times_desejados)) | (df['Away'].isin(times_desejados))) |
