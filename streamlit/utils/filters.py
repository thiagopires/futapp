...
def get_filter_lay_visitante_v2(df):
    ...
    return (
        df['Odd_A_FT'].between(2.5, 5) & (
            ...
            ((df['League'] == 'BELGIUM - PRO LEAGUE') & (df['Probabilidade_A_FT'].between(0.21, 0.3)) & (df['CV_HDA_FT'].between(0.25, 0.3))) |
            ...
            ((df['League'] == 'ENGLAND - EFL LEAGUE TWO') & (df['Probabilidade_A_FT'].between(0.39, 0.48)) & (df['CV_HDA_FT'].between(0.1, 0.15))) |
            ((df['League'] == 'ENGLAND - PREMIER LEAGUE') & (df['Probabilidade_A_FT'].between(0.21, 0.3)) & (df['CV_HDA_FT'].between(0.15, 0.2))) |
            ...
            ((df['League'] == 'GERMANY - BUNDESLIGA') & (df['Probabilidade_A_FT'].between(0.12, 0.21)) & (df['CV_HDA_FT'].between(0.3, 0.35))) |
            ...
            ((df['League'] == 'GERMANY - BUNDESLIGA') & (df['Probabilidade_A_FT'].between(0.3, 0.39)) & (df['CV_HDA_FT'].between(0.2, 0.25))) |
            ((df['League'] == 'ITALY - SERIE B') & (df['Probabilidade_A_FT'].between(0.3, 0.39)) & (df['CV_HDA_FT'].between(0.0, 0.05))) |
            ((df['League'] == 'ITALY - SERIE B') & (df['Probabilidade_A_FT'].between(0.3, 0.39)) & (df['CV_HDA_FT'].between(0.15, 0.2))) |
            ((df['League'] == 'ITALY - SERIE B') & (df['Probabilidade_A_FT'].between(0.39, 0.48)) & (df['CV_HDA_FT'].between(0.1, 0.15))) |
            ((df['League'] == 'JAPAN - J1 LEAGUE') & (df['Probabilidade_A_FT'].between(0.3, 0.39)) & (df['CV_HDA_FT'].between(0.2, 0.25))) |
            ...
            ((df['League'] == 'SAUDI ARABIA - SAUDI PROFESSION') & (df['Probabilidade_A_FT'].between(0.21, 0.3)) & (df['CV_HDA_FT'].between(0.35, 0.4))) |
            ((df['League'] == 'SCOTLAND - PREMIERSHIP') & (df['Probabilidade_A_FT'].between(0.21, 0.3)) & (df['CV_HDA_FT'].between(0.1, 0.15))) |
            ((df['League'] == 'SPAIN - LA LIGA') & (df['Probabilidade_A_FT'].between(0.12, 0.21)) & (df['CV_HDA_FT'].between(0.35, 0.4))) |
            ...
            ((df['League'] == 'TURKEY - SÜPER LIG') & (df['Probabilidade_A_FT'].between(0.39, 0.48)) & (df['CV_HDA_FT'].between(0.1, 0.15)))         
        )
    )