...
def get_filter_betfair_lay_0x1(df):
    return (
        ...
        (df["Odd_CS_0x1_Lay"] <= 30) & (
            ...
            ((df['League'] == 'ITALY - SERIE B') & (df['FX_Probabilidade_A'] == '0.30-0.39') & (df['FX_CV_HDA'] == '0.05-0.10')) |
            ...
            ((df['League'] == 'SCOTLAND - PREMIERSHIP') & (df['FX_Probabilidade_A'] == '0.12-0.21') & (df['FX_CV_HDA'] == '0.50-0.55')) |
